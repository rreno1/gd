...
window.GDLessons["grids"] = {
  ...
  "misconceptions": [
    {
      "claim": "A grid makes every layout look rigid and identical.",
      "correction": "A grid establishes shared relationships; varied spans, offsets, scale, layers, and deliberate exceptions can produce many distinct compositions."
    },
    {
      "claim": "Web layouts should always use twelve columns.",
      "correction": "Twelve is a common, divisible choice, but the appropriate track count follows the content, format, team workflow, and required spans."
    },
    {
      "claim": "CSS Grid is always for pages and Flexbox is always for components.",
      "correction": "Grid often helps when two-dimensional tracks matter and Flexbox often helps along one main axis, but either can solve many layouts and they are frequently nested together."
    },
    {
      "claim": "The rule of thirds automatically creates a balanced composition.",
      "correction": "Thirds offer candidate alignments for exploration; subject matter, cropping, hierarchy, movement, and context determine whether the result works."
    }
  ],
  "sections": [
    {
    ...
    },
    {
      ...
      "body": [
        ...
        "Spatial zones provide structural flexibility. In a dashboard layout, a trend chart might span four modules wide by two modules high, while individual summary cards occupy a single module each. This allows highly diverse content types to sit side-by-side within a unified, consistent framework. The modules enforce a shared mathematical proportion, ensuring that all elements — regardless of their size — look like they belong to the same grid system. When building a modular grid, the proportions of the module must be tested against the content. If the base module is too small, managing content spans becomes overly complex and the layout grid becomes cluttered. If the module is too large, it limits layout flexibility, forcing content into awkward dimensions. Designers test modules using real-world content, ensuring that typical blocks (like an image card with a heading and button) fit cleanly within standard module spans."
      ],
      "keyPoints": [
    ...
    },
    {
      ...
      "body": [
        "In modern web design, layouts must function across a vast range of screen sizes, from mobile phones to high-resolution desktop monitors. A responsive grid is a system that adapts its structure — margins, track count, gutter size, and content order — as available screen space changes. Rather than building static designs for a few specific devices, designers build flexible systems that reflow content gracefully, ensuring that hierarchy, legibility, and usability are preserved at all viewports. Responsive grid adaptation is managed using breakpoints — conditions (usually screen widths) at which the layout rules change. A common workflow defines three major layout states: mobile (typically a 1-column layout with 16px margins), tablet (a 4-column or 6-column layout with 24px margins), and desktop (a 12-column layout with wider margins). As the viewport crosses a breakpoint, the layout track count updates and content wraps. Breakpoints should be determined by content pressure — where a column gets too narrow or text wraps awkwardly — not by device labels.",
        "Content reflow must preserve the logical reading order and keyboard focus sequence. When columns collapse on smaller screens, elements typically stack vertically in the order they appear in the HTML document. If a designer uses styling rules to rearrange elements visually (such as placing a sidebar before the main content in CSS but keeping it after in HTML), they create a confusing mismatch for screen readers and keyboard users. Accessibility guidelines require that the visual layout matches the semantic document order. Modern responsive systems combine fluid units with minimum and maximum constraints to reduce the need for abrupt breakpoint changes. By using CSS units like percentages, viewport width (`vw`), and fractional tracks (`fr`), grids scale smoothly between breakpoints. Enforcing min-width and max-width rules prevents elements from becoming unreadably small or stretched. This fluid approach creates a layout that feels organic and responsive to the user's specific viewing window, rather than jumping between rigid states."
      ],
      "keyPoints": [
  ...
  "review": [
    {
      "question": "What does a grid system contribute to a visual composition?",
      "answer": "It provides a structured alignment framework that coordinates margins, columns, gutters, and spacing. This creates visual consistency, order, and harmony across pages, making layouts easier to navigate."
    },
    {
      "question": "How does a gutter differ from a column in grid anatomy?",
      "answer": "A column is an active vertical track designed to hold and align content (text, images, buttons). A gutter is the inactive spatial gap separating columns to prevent content from running together."
    },
    {
      "question": "What is a flowline, and how is it used in layout design?",
      "answer": "A flowline is a horizontal guideline that runs across columns. It coordinates horizontal alignments, section starts, and eye pauses, helping to build horizontal structure."
    },
    {
      "question": "When is a modular grid preferred over a simple column grid?",
      "answer": "When organizing dense, repetitive, or structured content that features both horizontal and vertical relationships, such as data cards, dashboards, catalogues, and calendars."
    },
    {
      "question": "Why are twelve-column grids popular, and what is their main benefit?",
      "answer": "Twelve columns are highly divisible, splitting evenly into halves, thirds, quarters, and sixths. This allows designers to build multiple layout variations (spans of 2, 3, 4, 6, or 12 columns) on the same page."
    },
    {
      "question": "How should breakpoints be determined in responsive design?",
      "answer": "Based on content pressure — the point where column width, text wrapping, or component spacing compromises legibility or usability — rather than chasing device dimensions."
    },
    {
      "question": "How do CSS Grid and Flexbox differ, and when should they be combined?",
      "answer": "CSS Grid is a two-dimensional layout system (columns and rows); Flexbox is a one-dimensional system (single row or column). They are combined by using Grid for outer page layouts and Flexbox for component-level items."
    }
  ],
  "quiz": [
    {
      "question": "What are the inactive spaces that separate adjacent grid columns called?",
      "options": [
        "Margins",
        "Gutters",
        "Flowlines",
      ...
      "answer": 1,
      "explanation": "Gutters are the inactive vertical gaps separating adjacent columns or rows to prevent content overlap and maintain readability."
    },
    {
      "question": "What does a margin define in a grid system?",
      "options": [
        "The negative space boundary surrounding the principal content field",
        "A vertical track for aligning text blocks",
        "The gap between adjacent row modules",
        "An interactive button state"
      ],
      "answer": 0,
      "explanation": "Margins are the empty spaces between the outer edges of the format (page or screen) and the active content area."
    },
    {
      "question": "What is the primary role of a horizontal flowline?",
      "options": [
        "To divide vertical columns into smaller tracks",
        "To coordinate horizontal alignments and section starts across columns",
        "To set all text columns to justified alignment",
        "To replace margin spacing on mobile devices"
      ],
      "answer": 1,
      "explanation": "Flowlines provide horizontal reference points that align elements across different columns, creating horizontal structure and rhythm."
    },
    {
      "question": "What is a module?",
      "options": [
        "The margin spacing at the top of the page",
        "A unit formed by the intersection of columns and rows",
        "Any border or divider line in CSS",
        "A device viewport breakpoint"
      ],
      "answer": 1,
      "explanation": "A module is an individual cell created where vertical columns and horizontal rows cross in a modular grid."
    },
    {
      "question": "What is a spatial zone in a grid?",
      "options": [
        "A group of adjacent modules or tracks assigned to a recurring content role",
        "The space between two adjacent letters",
        "A media query breakpoint value",
        "The area reserved for loading indicators"
      ],
      "answer": 0,
      "explanation": "Spatial zones combine adjacent modules or tracks into larger logical fields for specific content roles, such as sidebars or galleries."
    },
    {
      "question": "Which grid type begins with a single principal text field and wide margins?",
      "options": [
        "Modular grid",
        "Manuscript grid",
        "Column grid",
      ...
      "answer": 1,
      "explanation": "A manuscript grid features one primary text column and is optimized for continuous, long-form reading (like novels and reports)."
    },
    {
      "question": "Which grid type adds horizontal row divisions to vertical columns?",
      "options": [
        "Manuscript grid",
        "Modular grid",
        "Baseline grid",
      ...
      "answer": 1,
      "explanation": "A modular grid uses both vertical column tracks and horizontal row tracks to create a matrix of modules."
    },
    {
      "question": "What distinguishes a hierarchical grid from other grid types?",
      "options": [
        "It requires exactly twelve equal columns",
        "It derives alignments from the custom proportions and importance of the content itself",
        "It prohibits elements from spanning multiple tracks",
        "It is used exclusively for printed books"
      ],
      "answer": 1,
      "explanation": "Hierarchical grids do not use uniform repeated modules, instead deriving custom alignments based on content hierarchy and proportions."
    },
    {
      "question": "Why is twelve a common column count in grid systems?",
      "options": [
        "It is the only column count supported by screens",
        "It divides easily into halves, thirds, quarters, and sixths, providing high layout flexibility",
        "It is mandated by WCAG accessibility guidelines",
        "It eliminates the need for gutters"
      ],
      "answer": 1,
      "explanation": "A 12-column grid is highly divisible, allowing designers to create 2, 3, 4, or 6 column spans within a single visual grid."
    },
    {
      "question": "How should the rule of thirds be treated in composition?",
      "options": [
        "As a guaranteed formula for perfect visual balance",
        "As a useful compositional prompt to test against alternatives",
        "As a legal requirement for brand mark design",
        "As a replacement for text hierarchy guides"
      ],
      "answer": 1,
      "explanation": "The rule of thirds suggests placing focal points along lines or intersections, serving as a prompt for exploring asymmetrical layouts."
    },
    {
      "question": "What is the strongest basis for adding a responsive breakpoint?",
      "options": [
        "A popular device name or model size",
        "A point where content pressure compromises legibility, alignment, or usability",
        "Every 100 pixels of screen width increase",
        "The number of images placed in the layout"
      ],
      "answer": 1,
      "explanation": "Breakpoints should be content-driven, placed at the viewport widths where the content starts to break, overlap, or become hard to read."
    },
    {
      "question": "Which CSS layout module is a two-dimensional system designed to control both columns and rows?",
      "options": [
        "Flexbox",
        "CSS Grid",
        "Float positioning",
      ...
      "answer": 1,
      "explanation": "CSS Grid is a two-dimensional layout system that manages columns and rows simultaneously, ideal for structured page grid architectures."
    },
    {
      "question": "When are CSS Grid and Flexbox commonly nested together?",
      "options": [
        "Never, they are incompatible modules",
        "When an outer track system and an inner component require different alignment behavior",
        "Only in print media layouts",
        "Only when the grid contains exactly twelve items"
      ],
      "answer": 1,
      "explanation": "Grid and Flexbox are nested to combine structural alignment with component flexibility (e.g., placing cards on a page grid, while aligning text inside each card using Flexbox)."
    },
    {
      "question": "Which test is most likely to expose layout bugs in a grid system?",
      "options": [
        "Using only identical placeholder cards",
        "Testing with extreme text lengths, missing data fields, and browser zoom",
        "Removing all column guides during review",
        "Counting the number of lines in the grid"
      ],
      "answer": 1,
      "explanation": "Stress-testing with extreme text, missing content, and zoom reveals where tracks, wrapping rules, or gutters fail in real-world use."
    },
    {
      "question": "What must remain consistent and logical when responsive layouts visually rearrange content?",
      "options": [
        "The desktop column count",
        "The document reading order and keyboard focus sequence of the code",
        "The rule-of-thirds intersection alignments",
        "The width of the page margins"
      ],
      "answer": 1,
      "explanation": "Responsive reflow must maintain the document's logical reading and keyboard focus sequence to ensure visual updates do not break accessibility."
    }
  ],
  "summary": {
    "takeaways": [
