...
window.GDLessons["contrast-accessibility"] = {
  ...
  sections: [
    {
      ...
      detailedNotes: [
        "In legal contexts, meeting accessibility standards is increasingly mandated by regulations worldwide, such as Section 508 of the Rehabilitation Act in the United States, the European Accessibility Act (EAA), and regional web accessibility laws in Canada and Australia. Non-compliance can result in substantial lawsuits, civil penalties, and public damage to corporate reputation. For government, educational, and public-facing organizations, achieving WCAG 2.1 or 2.2 Level AA compliance is typically the baseline legal standard.",
        "The POUR principles are broken down into testable success criteria, graded into three levels of conformance: A (minimum accessibility requirements), AA (the global standard for mid-level accessibility, resolving the most common barriers), and AAA (the enhanced standard for specialized or high-level accessibility). Most design contracts and corporate policies target Level AA compliance, which provides a highly inclusive experience without placing excessive restrictions on visual aesthetics.",
  ...
  review: [
    { question: "What are the four core principles of web accessibility under WCAG?", answer: "Perceivable, Operable, Understandable, and Robust (POUR)." },
    { question: "What are the WCAG 2.2 Level AA contrast requirements for text?", answer: "At least 4.5:1 for normal-sized text and at least 3:1 for large-scale text." },
    { question: "What is the WCAG Level AAA contrast requirement for normal text?", answer: "At least 7:1 contrast against the background." },
    { question: "Why is a contrast check of 4.499:1 considered a failure?", answer: "Because WCAG thresholds are absolute minimums. Visual values must not be rounded up to pass, and color adjustments must be made until it meets or exceeds 4.5:1." },
    { question: "What contrast requirement applies to essential UI components and graphical parts?", answer: "Under Non-text Contrast, they must have at least a 3:1 contrast ratio against adjacent colors." },
    { question: "How should status changes be communicated in an accessible design?", answer: "Never depend on color alone; always pair color changes with text labels, distinct icons, shapes, patterns, or positional changes." },
    { question: "How do WCAG AA pointer target minimums and Apple touch target guidelines differ?", answer: "WCAG 2.2 AA specifies a minimum target size of 24x24 CSS pixels or spacing exceptions. Apple's guideline recommends a larger 44x44 point size for iOS interfaces." },
    { question: "What determines the content of alternative text for an image?", answer: "The image's functional purpose and the information it contributes within the surrounding context." }
  ],

  quiz: [
    { question: "What is the WCAG 2.2 Level AA minimum contrast ratio for normal-sized body text?", options: ["3.0:1", "4.5:1", "7.0:1", "21:1"], answer: 1, explanation: "Under Level AA success criteria, normal text requires a contrast ratio of at least 4.5:1 against the background." },
    { question: "What is the WCAG 2.2 Level AA minimum contrast ratio for large-scale text?", options: ["2.0:1", "3.0:1", "4.5:1", "7.0:1"], answer: 1, explanation: "Large-scale text (18pt/24px and above, or 14pt/18.67px bold) requires at least a 3:1 contrast ratio for Level AA." },
    { question: "What is the WCAG Level AAA minimum contrast ratio for normal-sized text?", options: ["3.0:1", "4.5:1", "7.0:1", "12:1"], answer: 2, explanation: "The enhanced Level AAA standard requires a minimum contrast ratio of 7:1 for normal-sized text." },
    { question: "Which text size and weight qualifies as large-scale under WCAG guidelines?", options: ["Any text set in a bold heading element", "At least 18 point regular or at least 14 point bold", "Any text rendering above 14 CSS pixels", "Only text in the main page H1 title"], answer: 1, explanation: "WCAG defines large-scale text as text at least 18pt regular (approx. 24px) or 14pt bold (approx. 18.67px)." },
    { question: "A text-background combination has a measured contrast of 4.495:1. Does it pass the AA normal text standard?", options: ["Yes, because it rounds up to 4.5", "Yes, if the color used is accessibility-compliant green", "No, it fails because it is below the exact 4.5:1 minimum and rounding is not permitted", "Only if viewed on high-resolution screens"], answer: 2, explanation: "WCAG thresholds are exact minimums. A ratio of 4.495:1 is a failure, and the colors must be adjusted to meet or exceed 4.5:1." },
    { question: "In the WCAG contrast formula, what does L1 represent?", options: ["The relative luminance of the darker color", "The relative luminance of the lighter color", "The size of the font in pixels", "The width of the text column"], answer: 1, explanation: "L1 represents the relative luminance of the lighter color, placed as the numerator in the contrast formula." },
    { question: "What is the maximum contrast ratio possible under the WCAG formula?", options: ["4.5:1", "7.0:1", "10.0:1", "21.1:1 (commonly written as 21:1)"], answer: 3, explanation: "Pure black against pure white yields the maximum contrast ratio of 21:1." },
    { question: "What minimum contrast is required for active UI controls and essential graphics under WCAG Non-text Contrast?", options: ["1.5:1", "3.0:1", "4.5:1", "7.0:1"], answer: 1, explanation: "Essential visual components, input boundaries, and graphical parts require a contrast ratio of at least 3:1 against adjacent colors." },
    { question: "Why is it an accessibility violation to use red and green color changes as the only indicator of success or error?", options: ["Red and green are not corporate colors", "Color-blind users may not distinguish the colors, meaning color is the sole carrier of information", "Red-green combinations automatically slow down loading times", "The contrast ratio is always exactly 21:1"], answer: 1, explanation: "Accessible design must not rely on color alone to convey meaning. It must use redundant cues (like icons, text, or shapes) so colorblind users can perceive the information." },
    { question: "How should colorblindness simulators be used in the design process?", options: ["To verify that contrast ratios are mathematically correct", "To prove that the design conforms to all legal laws", "As an approximate diagnostic aid to identify potential color conflicts", "To automatically translate print files to screen colors"], answer: 2, explanation: "Simulators are diagnostic tools that help designers spot obvious color conflicts, but they are approximate and do not replace contrast checks." },
    { question: "What is the base target size required under WCAG 2.2 Level AA Target Size (Minimum)?", options: ["10x10 device pixels", "24x24 CSS pixels, or a spacing exception", "44x44 points in all cases", "100x100 CSS pixels"], answer: 1, explanation: "WCAG 2.2 AA SC 2.5.8 requires a target size of at least 24x24 CSS pixels, or spacing circles that meet exceptions." },
    { question: "How do WCAG 2.2 AA target size rules and Apple design recommendations differ?", options: ["WCAG requires 24 CSS pixels, while Apple recommends 44 points for its iOS platform", "They are identical rules using different terms", "WCAG applies to screens, Apple applies only to print", "Apple guidelines override WCAG standards legally"], answer: 0, explanation: "WCAG 2.2 AA specifies a 24x24 CSS pixel minimum. Apple's guidelines recommend a larger 44x44 point size, which is a separate platform guideline." },
    { question: "What is the primary function of a visible focus indicator?", options: ["To highlight decorative images on mouse hover", "To show keyboard users which element currently has input focus", "To show the download progress of web files", "To convert RGB hex codes to CMYK print targets"], answer: 1, explanation: "A visible focus indicator (like an outline focus ring) tells keyboard navigators exactly where they are on the screen." },
    { question: "How should a purely decorative image be configured in HTML to ensure accessibility?", options: ["Describe the decorative shapes in detail in the alt text", "Set the alt text to the filename of the image file", "Provide an empty alt attribute (alt=\"\") so screen readers ignore it", "Omit the alt attribute entirely from the image tag"], answer: 2, explanation: "Decorative images must use an empty alt attribute (alt=\"\"), which tells screen readers to silently skip the image. Omitting the alt attribute causes screen readers to read the filename." },
    { question: "What is the best practice for writing alternative text for images?", options: ["Always start with the phrase 'image of' or 'photo of'", "Limit all descriptions to exactly 50 characters", "Write text that communicates the image's relevant content or function in the surrounding context", "Repeat the caption text exactly to ensure redundancy"], answer: 2, explanation: "Alt text should convey the image's purpose or function in context, keeping it concise and avoiding redundant caption repetitions." }
  ],
