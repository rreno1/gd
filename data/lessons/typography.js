...
window.GDLessons["typography"] = {
  ...
  misconceptions: [
    { claim: "Serif type is always best for print and sans serif is always best for screens.", correction: "Well-designed examples of both categories work in print and on screens. Size, spacing, screen resolution, rendering engines, language, and viewing distance affect legibility far more than the presence or absence of serifs." },
    { claim: "Leading is the empty space between two visible lines of text.", correction: "Leading is measured baseline-to-baseline, not as the gap between letters. Therefore, the actual gap is influenced by the typeface's size, x-height, and internal metric defaults." },
    { claim: "A line of text should always contain exactly 45 to 75 characters.", correction: "This is a useful guideline for continuous body text, not a rigid law. Typeface proportions, column layout, device viewport, audience reading speed, and the purpose of the text all shape a comfortable measure." },
    { claim: "Two different typefaces automatically create a good pairing.", correction: "Pairings fail when typefaces are too similar (causing confusion) or too discordant in tone. A pairing succeeds when the faces have clear, distinct roles, compatible proportions, and contrasting structures." }
  ],
  ...
  sections: [
    ...
    },
    {
      ...
      detailedNotes: [
        ...
        "Typeface classifications also reflect production limitations. Slab-serif typefaces emerged during the Industrial Revolution, when printing presses began mass-producing large posters, handbills, and advertisements. Standard Roman typefaces were too delicate to stand out on crowded walls, so punchcutters thickened the strokes and serifs to create heavy, block-like letterforms that could be carved from wood and printed with high visibility. This is why slab serifs retain a strong graphic impact.",
    ...
    },
    {
      ...
      detailedNotes: [
        "Optical spacing is rooted in how the human eye perceives area. The brain processes the negative space between letters as volume. A letter with a vertical stem (like 'I') has less surrounding space than a letter with a curve (like 'O') or a diagonal (like 'V'). If you place 'I-I' and 'O-O' at the exact same physical distance, the 'I-I' pair will look tight and dark, while 'O-O' will look loose. Type designers and typesetters adjust spacing so that the volume of negative space between all letters appears visually equal.",
    ...
    },
    {
      ...
      detailedNotes: [
        "When pairing typefaces, you can analyze their historical origins for compatibility. For example, pairing a slab-serif (originally developed in the 19th century for advertising) with a geometric sans-serif (developed in the 20th century) can create a bold, editorial aesthetic because both share a strong graphic structure. Pairing a Renaissance-era Old Style serif (like Garamond) with a contemporary neo-grotesque sans (like Helvetica) can sometimes clash because their historical philosophies — organic hand-carving versus mechanical neutrality — compete rather than collaborate.",
        "A useful concept in font pairing is the superfamily. A superfamily is a collection of typefaces designed by the same creator that contains matching serif, sans-serif, slab-serif, or rounded variants (examples include PT Serif/PT Sans, Merriweather/Merriweather Sans, or Museo). Because all variants in a superfamily share the same underlying structure, cap height, x-height, and proportions, they can be paired with absolute assurance of visual harmony, simplifying the system building process.",
  ...
  review: [
    { question: "How do typeface and font differ?", answer: "A typeface is the design family (e.g., Helvetica); a font is the specific file or instance of that design (e.g., 12pt Helvetica Bold)." },
    { question: "What does x-height describe, and why does it matter for legibility?", answer: "x-height is the height of lowercase letter bodies. A larger x-height makes lowercase letters appear larger and more legible at small sizes, though it may require more line spacing (leading)." },
    { question: "How do kerning, tracking, and leading differ in their applications?", answer: "Kerning adjusts space between a specific pair of letters (optical adjustments); tracking adjusts spacing across a range of text; leading sets baseline-to-baseline vertical distance between lines." },
    { question: "Why is 45 to 75 characters per line considered the optimal measure for body copy?", answer: "It prevents reader eye strain — wide columns make it hard to find the next line start, while narrow columns disrupt reading flow and create awkward word breaks." },
    { question: "When is a single type family superior to a font pairing?", answer: "When the family provides sufficient weights (regular, bold, italic, etc.) to build a complete hierarchy, ensuring visual consistency, smaller file sizes, and better load performance." },
    { question: "How should visible typographic hierarchy align with semantic code structure?", answer: "Visual levels (size, weight) must match HTML header tags (h1-h6) sequentially so screen readers and search engines navigate and interpret the content structure correctly." }
  ],

  quiz: [
    { question: "Which horizontal reference line supports the main body of most letterforms?", options: ["x-height line", "Ascender line", "Baseline", "Cap height line"], answer: 2, explanation: "Most letterforms sit directly on the baseline, which serves as the primary horizontal alignment anchor for lines of text." },
    { question: "What is the recommended range of characters per line (measure) for continuous body text in a desktop viewport?", options: ["20 to 30 characters", "45 to 75 characters", "90 to 110 characters", "Over 150 characters"], answer: 1, explanation: "A measure of 45 to 75 characters per line (including spaces) is optimal for comfortable continuous reading, preventing eye fatigue and reading errors." },
    { question: "What is leading?", options: ["The horizontal space across a range of text", "The adjustment of space between a specific character pair", "The vertical distance from one baseline of text to the next", "The alignment of text blocks to a grid"], answer: 2, explanation: "Leading (line height) is the vertical distance from one line's baseline to the next. It establishes the vertical rhythm of text blocks." },
    { question: "Which typeface classification features finishing strokes at the ends of character lines?", options: ["Sans-serif", "Serif", "Monospaced", "Display"], answer: 1, explanation: "Serif typefaces are characterized by finishing strokes, terminals, or structural details (serifs) at the ends of character lines." },
    { question: "Which typeface classification omits traditional finishing strokes?", options: ["Serif", "Script", "Slab-serif", "Sans-serif"], answer: 3, explanation: "Sans-serif typefaces (from 'sans', meaning 'without' in French) omit finishing strokes, featuring clean, relatively uniform lines." },
    { question: "What is kerning?", options: ["Consistent spacing applied across a whole block of text", "The adjustment of space between a specific pair of adjacent characters", "The height of lowercase letters relative to uppercase", "The width of the text column"], answer: 1, explanation: "Kerning is the selective optical spacing adjustment between specific character pairs (e.g., 'AV', 'Te') to ensure visual uniformity." },
    { question: "What is tracking?", options: ["Consistent adjustment to spacing across a selected range of characters", "The height of capital letters above the baseline", "The visual path the reader's eye follows through a page", "The ratio of column width to margin size"], answer: 0, explanation: "Tracking (letter-spacing) is the uniform tightening or loosening of spacing across a selected range of text or an entire paragraph." },
    { question: "What is the portion of a lowercase letter that rises above the x-height?", options: ["Descender", "Stem", "Ascender", "Serif"], answer: 2, explanation: "An ascender is the portion of lowercase letters (like 'h', 'd', 'b') that extends above the standard x-height of the typeface." },
    { question: "What is the portion of a lowercase letter that projects below the baseline?", options: ["Ascender", "Descender", "Counter", "Aperture"], answer: 1, explanation: "A descender is the portion of lowercase letters (like 'g', 'p', 'y') that falls below the baseline." },
    { question: "Which category draws from connected, cursive, or calligraphic letterforms?", options: ["Serif", "Script", "Monospaced", "Geometric sans"], answer: 1, explanation: "Script typefaces draw from handwritten, cursive, or formal calligraphic writing traditions, often used for expressive display settings." },
    { question: "What is a type family?", options: ["All fonts designed by the same person", "A related system of weights, widths, and styles within one typeface design", "A collection of typefaces preinstalled on a operating system", "The hierarchy levels used in an editorial document"], answer: 1, explanation: "A type family groups related styles (such as regular, italic, bold, condensed, or variable instances) based on a single typeface design." },
    { question: "What does x-height refer to?", options: ["The width of a text column in pixels", "The height of the main lowercase letter body, excluding ascenders and descenders", "The height of capital letters above the baseline", "The distance between consecutive baselines"], answer: 1, explanation: "x-height is the height of the main body of lowercase letters, conventionally measured by the height of the lowercase 'x' above the baseline." },
    { question: "Which typographic role is designed specifically for sustained, continuous reading?", options: ["Display heading", "Caption", "Body copy", "Section label"], answer: 2, explanation: "Body copy represents the main continuous text block of a design, requiring a highly readable typeface, size, and layout." },
    { question: "What is a display typeface?", options: ["A typeface designed specifically for large, prominent settings like headlines and signs", "A font file format that works only on screens", "A typeface with uniform character widths", "A system font preinstalled on all browsers"], answer: 0, explanation: "Display typefaces are designed for large, prominent applications where expressive or delicate detail is needed, and should not be used for body text." },
    { question: "According to WCAG guidelines, what is the minimum contrast ratio required for large text?", options: ["4.5:1", "3.0:1", "7.0:1", "1.5:1"], answer: 1, explanation: "WCAG guidelines require a minimum contrast ratio of 3.0:1 for large text (18pt/24px and above, or 14pt/18.67px bold) to ensure accessibility." }
  ],
